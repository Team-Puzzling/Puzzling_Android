...
class DetailRetroAdapter() :
    ListAdapter<ResponseDetailRetroDto.Content, DetailRetroAdapter.DetailRetroViewHolder>(
        diffCallback,
    ) {
    ...
    inner class DetailRetroViewHolder(private val binding: ItemDetailRetroBinding) :
        ...
        fun onBind(item: ResponseDetailRetroDto.Content) {
    ...
    companion object {
        private val diffCallback =
            ItemDiffCallback<ResponseDetailRetroDto.Content>(
