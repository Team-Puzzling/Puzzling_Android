...
import com.puzzling.puzzlingaos.databinding.ItemTeamBoardBinding
...
class TeamPuzzleBoardAdapter :
    ...
    class TeamPuzzleBoardViewHolder(private val binding: ItemTeamBoardBinding) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): TeamPuzzleBoardViewHolder {
        val binding =
            ItemTeamBoardBinding.inflate(LayoutInflater.from(parent.context), parent, false)
